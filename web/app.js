...
const translations = {
  en: {
    ...
    step2_btn: 'Run Test',
    step25_title: 'Session Management',
    step25_desc: 'Manage DeepSeek chat sessions: list, delete, summarize, create new.',
    step25_debug: 'Go to Debug Panel → Sessions',
    ...
    api_sessions_list: 'List recent DeepSeek chat sessions (default 10)',
    api_sessions_new: 'Create a new chat session',
    api_sessions_delete: 'Delete a chat session by ID',
    api_sessions_summarize: 'Generate a summary of a chat session',
    testing: 'Testing...',
  ...
  zh: {
    ...
    step2_btn: '运行测试',
    step25_title: '会话管理',
    step25_desc: '管理 DeepSeek 的历史会话：查看、删除、生成摘要、新建会话。',
    step25_debug: '前往调试面板 → 会话管理',
    ...
    api_sessions_list: '列出最近的 DeepSeek 会话（默认 10 条）',
    api_sessions_new: '新建聊天会话',
    api_sessions_delete: '根据 ID 删除会话',
    api_sessions_summarize: '生成会话摘要',
    testing: '测试中...',
    sending: '\u6b63\u5728\u53d1\u9001\u6d4b\u8bd5\u8bf7\u6c42...',
    success: '\u6210\u529f\uff01\u56de\u590d\uff1a',
    error: '\u9519\u8bef\uff1a',
